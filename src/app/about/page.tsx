...
const HISTORY = [
  ...
  { year: '2025', items: ["산업통상자원부 주관 '우수 스마트 팩토리 공급 기업' 선정", 'AI 기반 용접 불량 실시간 검출 시스템(INS LC-AD 시리즈) 자동차 부품 1차 벤더 양산 라인 전면 도입', '벤처기업 인증 및 기술혁신형 중소기업(Inno-Biz) 인증 획득', '신호 데이터 고속 처리 및 AI 딥러닝 병렬 분석 관련 핵심 특허 3건 등록'] },
      ...
      {tab === '5' && (
        <>
          ...
          <div className="cert-grid">
            {[
              { title: 'KC 인증', desc: '방송통신기자재 적합등록 통과. 노이즈 환경에서도 안정적 동작.' },
              { title: 'ISO 9001', desc: '품질경영시스템 인증. 설계부터 유지보수까지 체계적 품질 관리.' },
              { title: 'ISO 14001', desc: '환경경영시스템 인증. 친환경 경영 구축.' },
              { title: 'CE 인증', desc: '유럽연합 통합 안전 규격. 글로벌 수출 가능한 안전성 기준 충족.' },
              { title: 'Inno-Biz', desc: '기술혁신형 중소기업 인증. 기술 우위 기반 혁신 강소기업.' },
            ].map(c => (
